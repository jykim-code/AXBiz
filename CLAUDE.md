...
- **개조식 + 명사형 종결**: `~함 / ~됨 / ~임 / ~음 / ~필요` 로 끝낸다. 서술형(`~이다 / ~한다`) 금지.
...
- **길이는 기존 항목 수준을 넘지 않는다** (최근 20건 실측 기준):
  주요내용 **3~8개, 각 50~150자** / 시사점 **1개, 200~500자** / 한컴 인사이트 **1개, 300~570자** / 태그 **5~11개** / 본문 총 **1,200~1,900자**.
